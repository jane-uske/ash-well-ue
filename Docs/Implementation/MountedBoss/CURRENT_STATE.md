> 最新接续（2026-09-12）：工作分支 `codex/mounted-charge-standard`，当前代码 **c62edc2**，回退点 **8a78f76**。三项同步已进入运行候选：整体人马/斧盾/碰撞1.30倍，8组24个声音变体，真实盾挡及六招自然选择。c2e44ae的22项战斗+8项坡地+2项守井者回归通过；c62edc2仅修马蹄接地采样与复位缓存，补测5项通过，**没有宣称37项同版本全跑**。现有A/六招/B/击中与盾挡录像对应c2e44ae；最新补录被Mac重新锁屏阻塞，已请求解锁。原版缺失招式尚未补齐，其他五招仍是兼容动画，A/B待动态验收、C未初测。详见 [本轮文档](SIZE_SOUND_MOVES_SYNC_20260912.md) 及 `Docs/Verification/MountedChargeSample/SyncSizeSoundMoves/delivery.json`。以下为历史记录。
